...
//            add("https://www.iteye.com/");
//            add("https://www.imooc.com/");
//            add("https://juejin.im/");
//            add("https://v2ex.com/");
//            add("https://www.oschina.net/");
//            add("https://www.cnblogs.com/");
//            add("https://blog.csdn.net/");
//        }};
//        set.forEach(this::myPrint);
    }
                        ...
                        while ((line = reader.readLine()) != null) {
                            ...
                            if (matcher.find()) {
                                ...
                                if (!oldMap.containsKey(newLink)
                                    ...
                                    //对博客文章进行爬取
                                    HunterProcessor hunter = new BlogHunterProcessor(newLink, true);
